 ...
 * @throws Exception 
  ...
  public ResponseEntity<?> registerPanel(@RequestBody Panel panel) throws Exception {
	  ...
	  if((panel != null) && (panel.getSerial() != null) && ( panel.getSerial().trim().length()==16)){ 
		  ...
		  //appropriately. we can either throw the exception or just sent not okay request
		  //throw new Exception("Serial not appropriate");
  ...
  public ResponseEntity<?> saveHourlyElectricity(
	  ...
	  //Bug 2: Project accepts data for registered panel only 
